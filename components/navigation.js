  ...
  return (
    <nav className='font-mono'>
        <ul className="flex md:space-x-4 flex-col md:flex-row">
            <li>
                <Link href="/" className={`${className} inline md:hidden`}>Home</Link>
            </li>
            <li>
                <Link href="/about" className={className}>About</Link>
            </li>
            <li>
                <Link href="/about/projects" className={className}>Projects</Link>
            </li>
            <li>
                <Link href="/photos" className={className}>Photos</Link>
            </li>
            <li>
